...
<section class="content">
    <div class="card">
        <div class="card-header">
            ...
            <div>
                <a href="{{ secure('berkas_pbj.add') }}" class="btn btn-primary">
...
<script>
    $(document).ready(function() {
        $('#previewBerkasPBJ').DataTable({
            ...
            "processing": true,
            "ajax": {
                "url": "{{ secure('berkas_pbj.dataTable') }}",
                "dataType": "json",
                "type": "POST",
                "data": {
                    _token: "{{csrf_token()}}"
    ...
    function showBappDetails(nomorKontrak) {
        $.ajax({
            url: "{{ secure('berkas_pbj.getBappDetails') }}",
            type: 'POST',
            data: {
    ...
    function showBastpDetails(nomorKontrak) {
        $.ajax({
            url: "{{ secure('berkas_pbj.getBastpDetails') }}",
            type: 'POST',
            data: {
                nomor_kontrak: nomorKontrak,
                _token: "{{csrf_token()}}"
    ...
    function showPhoDetails(nomorKontrak) {
        $.ajax({
            url: "{{ secure('berkas_pbj.getPhoDetails') }}",
            type: 'POST',
            data: {
                nomor_kontrak: nomorKontrak,
                _token: "{{csrf_token()}}"
    ...
    function showFhoDetails(nomorKontrak) {
        $.ajax({
            url: "{{ secure('berkas_pbj.getFhoDetails') }}",
            type: 'POST',
            data: {
                nomor_kontrak: nomorKontrak,
                _token: "{{csrf_token()}}"
    ...
    //                 window.location.href = "{{ secure('berkas_pbj.update', ['nomor_kontrak' => ':nomor_kontrak']) }}".replace(':nomor_kontrak', nomorKontrak);
    ...
    function editData(nomorKontrak) {
        ...
        form.method = 'GET';
        form.action = "{{ secure('berkas_pbj.update') }}";
