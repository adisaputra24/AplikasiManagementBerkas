...
<section class="content">
    <div class="card">
        <div class="card-header">
            ...
            <div>
                <a href="{{ url('berkas_pbj.add') }}" class="btn btn-primary">
...
<script>
    ...
    function showBappDetails(nomorKontrak) {
        $.ajax({
            url: "{{ url('berkas_pbj.getBappDetails') }}",
            type: 'POST',
            data: {
    ...
    function showBastpDetails(nomorKontrak) {
        $.ajax({
            url: "{{ url('berkas_pbj.getBastpDetails') }}",
            type: 'POST',
            data: {
                nomor_kontrak: nomorKontrak,
                _token: "{{csrf_token()}}"
    ...
    function showPhoDetails(nomorKontrak) {
        $.ajax({
            url: "{{ url('berkas_pbj.getPhoDetails') }}",
            type: 'POST',
            data: {
                nomor_kontrak: nomorKontrak,
                _token: "{{csrf_token()}}"
    ...
    function showFhoDetails(nomorKontrak) {
        $.ajax({
            url: "{{ url('berkas_pbj.getFhoDetails') }}",
            type: 'POST',
            data: {
                nomor_kontrak: nomorKontrak,
                _token: "{{csrf_token()}}"
    ...
    //                 window.location.href = "{{ url('berkas_pbj.update', ['nomor_kontrak' => ':nomor_kontrak']) }}".replace(':nomor_kontrak', nomorKontrak);
    ...
    function editData(nomorKontrak) {
        ...
        form.method = 'GET';
        form.action = "{{ url('berkas_pbj.update') }}";
