    ...
    <form method="post" enctype="multipart/form-data" id="form-edit-berkas">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nomor_kontrak" name="nomor_kontrak" class="form-control @error('nomor_kontrak') is-invalid @enderror" placeholder="Masukkan Nomor Kontrak" value="{{ old('nomor_kontrak', $berkas_pbj->nomor_kontrak) }}" required>
                                    @error('nomor_kontrak')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nama_kontrak" name="nama_kontrak" class="form-control @error('nama_kontrak') is-invalid @enderror" placeholder="Masukkan Nama Kontrak" value="{{ old('nama_kontrak', $berkas_pbj->nama_kontrak) }}" required>
                                    @error('nama_kontrak')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="nilai_kontrak_pbj" name="nilai_kontrak_pbj" class="form-control @error('nilai_kontrak_pbj') is-invalid @enderror" placeholder="Masukkan Nilai Kontrak" value="{{ old('nilai_kontrak_pbj', $berkas_pbj->nilai_kontrak_pbj) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nama_vendor" name="nama_vendor" class="form-control @error('nama_vendor') is-invalid @enderror" placeholder="Masukkan Nama Vendor" value="{{ old('nama_vendor', $berkas_pbj->nama_vendor) }}" required>
                                    @error('nama_vendor')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nomor_bapp" name="nomor_bapp" class="form-control @error('nomor_bapp') is-invalid @enderror" placeholder="Masukkan Nomor BAPP" value="{{ old('nomor_bapp', $bapp->nomor_bapp) }}">
                                    @error('nomor_bapp')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nomor_permohonan_bapp" name="nomor_permohonan_bapp" class="form-control @error('nomor_permohonan_bapp') is-invalid @enderror" placeholder="Masukkan Nomor Permnohonan" value="{{ old('nomor_permohonan_bapp', $bapp->nomor_permohonan_bapp) }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="jumlah_bayar_termin_1_bapp" name="jumlah_bayar_termin_1_bapp" class="form-control @error('jumlah_bayar_termin_1_bapp') is-invalid @enderror" placeholder="Masukkan Jumlah Bayar Termin 1" value="{{ old('jumlah_bayar_termin_1_bapp', $bapp->jumlah_bayar_termin_1_bapp) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="jangka_waktu_pemeliharaan_bapp" name="jangka_waktu_pemeliharaan_bapp" class="form-control @error('jangka_waktu_pemeliharaan_bapp') is-invalid @enderror" placeholder="Masukkan Jangka Waktu Pemeliharaan" value="{{ old('jangka_waktu_pemeliharaan_bapp', $bapp->jangka_waktu_pemeliharaan_bapp) }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nomor_bastp" name="nomor_bastp" class="form-control @error('nomor_bastp') is-invalid @enderror" placeholder="Masukkan Nomor BASTP" value="{{ old('nomor_bastp', $bastp->nomor_bastp) }}">
                                    @error('nomor_bastp')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nomor_permohonan_bastp" name="nomor_permohonan_bastp" class="form-control @error('nomor_permohonan_bastp') is-invalid @enderror" placeholder="Masukkan Nomor Permnohonan" value="{{ old('nomor_permohonan_bastp', $bastp->nomor_permohonan_bastp) }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="jumlah_bayar_termin_1_bastp" name="jumlah_bayar_termin_1_bastp" class="form-control @error('jumlah_bayar_termin_1_bastp') is-invalid @enderror" placeholder="Masukkan Jumlah Bayar Termin 1" value="{{ old('jumlah_bayar_termin_1_bastp', $bastp->jumlah_bayar_termin_1_bastp) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="jangka_waktu_pemeliharaan_bastp" name="jangka_waktu_pemeliharaan_bastp" class="form-control @error('jangka_waktu_pemeliharaan_bastp') is-invalid @enderror" placeholder="Masukkan Jangka Waktu Pemeliharaan" value="{{ old('jangka_waktu_pemeliharaan_bastp', $bastp->jangka_waktu_pemeliharaan_bastp) }}">
                                        <div class="input-group-append">
                                            <span class="input-group-text">Hari</span>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nomor_ba_serah_terima_pho" name="nomor_ba_serah_terima_pho" class="form-control @error('nomor_ba_serah_terima_pho') is-invalid @enderror" placeholder="Masukkan Nomor BA Serah Terima PHO" value="{{ old('nomor_ba_serah_terima_pho', $pho->nomor_ba_serah_terima_pho) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="tanggal_ba_serah_terima_pho" name="tanggal_ba_serah_terima_pho" class="form-control @error('tanggal_ba_serah_terima_pho') is-invalid @enderror" placeholder="Masukkan Tanggal BA Serah Terima PHO" value="{{ old('tanggal_ba_serah_terima_pho', $pho->tanggal_ba_serah_terima_pho ) }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nomor_surat_permohonan_fho_vendor" name="nomor_surat_permohonan_fho_vendor" class="form-control @error('nomor_surat_permohonan_fho_vendor') is-invalid @enderror" placeholder="Masukkan Nomor Surat Permohonan FHO Vendor" value="{{ old('nomor_surat_permohonan_fho_vendor', $fho->nomor_surat_permohonan_fho_vendor) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="tanggal_surat_permohonan_fho_vendor" name="tanggal_surat_permohonan_fho_vendor" class="form-control @error('tanggal_surat_permohonan_fho_vendor') is-invalid @enderror" placeholder="Masukkan Tanggal Surat Permohonan FHO Vendor" value="{{ old('tanggal_surat_permohonan_fho_vendor', $fho->tanggal_surat_permohonan_fho_vendor) }}">
        ...
        <div class="row">
            <div class="col-12 mb-4">
                <a href="{{ secure('berkas_pbj.index') }}" class="btn btn-secondary">Cancel</a>
