...
class AkunController extends Controller
{
    ...
    public function tambahAkun(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            return redirect()->routes('akun.add', [], true)->with('status', 'Data telah tersimpan di database');
        }
    ...
    public function ubahAkun($id, Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return redirect()->to(route('akun.edit', ['id' => $usr->id], true))->with('status', 'Data telah tersimpan di database');
        }
